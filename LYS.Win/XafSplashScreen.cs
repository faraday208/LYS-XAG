...
namespace LYS.Win {
    public partial class XafSplashScreen : SplashScreen {
		private void LoadBlankLogo() {
            ...
            string blankLogoResourceName = assembly.GetName().Name + ".Images.wfslogo.svg";
        ...
        public XafSplashScreen() {
            InitializeComponent();
			LoadBlankLogo();
            this.labelCopyright.Text = "Copyright © " + DateTime.Now.Year.ToString() + " EURASIA Lojistik" +  System.Environment.NewLine + "All rights reserved.";
